...
public class PublisherLambda extends BaseComposableNode {
  ...
  public PublisherLambda(String[] args, long contextHandle) {
    ...
    this.timer = node.createWallTimer(500, TimeUnit.MILLISECONDS, ClockType.ROS_TIME, timerCallback, contextHandle);
  }
  ...
  public static void main(String[] args) throws InterruptedException {
    ...
    RCLJava.spin(new PublisherLambda(args, contextHandle), contextHandle);
  }
}
